...
const Login = () => {
   ...
   return (
      <>
         ...
         <Navbar  id='bglogin'>
            <Container>
               <Navbar.Brand>SamadhanZone</Navbar.Brand>
         ...
         <section className="vh-100 gradient-custom" id='logbg'>
            <div className="container py-5 h-100">
               <div className="row d-flex justify-content-center align-items-center h-100">
                  <div className="col-12 col-md-4 col-lg-6 col-xl-5">
                     <div className="card text-white " id='loginbg'>
                        <div className="card-body p-5 text-center">
                           <div className="mb-md-5 mt-md-2 pb-2">
                              <h2 className="fw-bold mb-2">Login For Registering the Complaint</h2>
                              <p className="text-white-50 mb-2">Please enter your Credentials!</p>
